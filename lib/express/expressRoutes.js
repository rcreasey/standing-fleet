module.exports = function (requestValidator, statusAction, pollAction, joinAction, createAction, leaveAction, postScanAction, postStatusAction, logger) {
	...
	pub.postRoutes = {
		...
		'/api/poststatus' : function (req, res) {
			requestValidator.validateHeaders(req, res, function () {
				requestValidator.validateSession(req, res, function () {
					logger.log('Processing \'poststatus\' request', 0)
