...
exports.validateRequestSize = function (req, res, next) {
	rawbody(req, {
		length: req.headers['content-length'],
		limit: settings.requestSizeLimit
	}, function (error, string) {
		if (error) return error_response.respond(req, res, 'request-size', 'Your request was too large');

		next();
	});
};

exports.staticRewrite = function (req, res, next) {
...
exports.redirect_http = function (req, res, next) {
...
pub.ssl_headers = function (req, res, next) {
