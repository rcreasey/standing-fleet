module.exports = function (scanService, eventService, memberService, headerParser, errorResponse, successResponse, settings, logger) {
	...
	pub.run = function (req, res) {
		...
		if (!checkScanDataIntegrity(scanData.types) || !checkScanDataIntegrity(scanData.classes) ) {
