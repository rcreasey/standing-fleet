module.exports = function (hostileService, eventService, memberService, standingsService, async, eveapi, headerParser, settings, errorResponse, successResponse, _) {
    ...
    async.waterfall([
      ...
      function(results, callback){
        ...
        _.forEach(results.characters, function(character) {
          ...
          // console.log( settings.whitelist.alliances );
          // console.log( settings.whitelist.corporations );
