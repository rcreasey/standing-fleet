module.exports = function (hostileService, eventService, memberService, async, eveapi, headerParser, errorResponse, successResponse, _) {
    ...
    async.waterfall([
      ...
      function(results, callback){
        ...
        _.forEach(results.characters, function(character) {
          ...
          // do a quick check here to see if corporationId or allianceId is in the whitelist
