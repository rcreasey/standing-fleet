module.exports = function (armadaService, memberService, sessionService, eventService, scanService, successResponse, errorResponse, headerParser, async) {
	...
	var showStatusForMember = function (req, res) {
		if (!sessionService.verifyStatus(req)) {
			return errorResponse.respond(res, 'status', 'You are checking status too frequently');
		}
